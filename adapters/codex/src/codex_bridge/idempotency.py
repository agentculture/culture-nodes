...
all — so it is a verbatim port of `colleague_bridge/idempotency.py`.
...
invocation produced, without re-running `codex exec` a second time.
...
class IdempotencyStore:
    ...
    against the ONE genuine concurrency source: a background runner thread
