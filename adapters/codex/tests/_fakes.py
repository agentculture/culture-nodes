"""Shared test doubles: a tiny stdlib callback receiver, reused by the
server unit tests and the real-subprocess integration tests so both speak
exactly the same fake §13.4 receiver shape. Protocol-generic — verbatim
port of colleague-bridge's own `tests/_fakes.py`."""
