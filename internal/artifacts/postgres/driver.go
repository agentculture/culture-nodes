...
// (migrations/0005_artifact_blobs.sql, a BYTEA column keyed by the same id
...
// (migrations/0005_artifact_blobs.sql).
...
// CASCADE foreign key, migrations/0005_artifact_blobs.sql) its bytes in the
