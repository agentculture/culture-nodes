...
INSERT INTO worker_presence (worker_id, hostname, revision, actor_keys, last_seen)
VALUES ($1, $2, $3, $4, $5)
ON CONFLICT (worker_id) DO UPDATE SET
    hostname = EXCLUDED.hostname,
    revision = EXCLUDED.revision,
    actor_keys = EXCLUDED.actor_keys,
    last_seen = EXCLUDED.last_seen`, presence.WorkerID, presence.Hostname, presence.Revision, presence.ActorKeys, presence.LastSeen)
	if err != nil {
