...
func TestFaultTwoWorkersNoDoubleCommit(t *testing.T) {
	...
	workerA := startWorker(t, "fault-worker-a-"+store.NewULID(), 5.0, 5, 20, 3000, "")
	workerB := startWorker(t, "fault-worker-b-"+store.NewULID(), 5.0, 5, 20, 3000, "")
...
func TestFaultDuplicateSignalExactlyOneEffectiveCompletion(t *testing.T) {
	...
	workerA := startWorker(t, "fault-dup-a-"+store.NewULID(), 5.0, 2, 20, 3000, "")
	workerB := startWorker(t, "fault-dup-b-"+store.NewULID(), 5.0, 2, 20, 3000, "")
