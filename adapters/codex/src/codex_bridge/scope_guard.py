...
broken prompt-side guard lived in the claude-code bridge ALONE — a boundary
present in one backend and absent in the other two, which is the
all-backends rule's own definition of a bug. This module is where that
boundary starts existing here.
"""
...
from codex_bridge import workspace
