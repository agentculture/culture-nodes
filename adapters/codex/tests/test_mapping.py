...
def test_usage_maps_extended_codex_telemetry_with_exact_grounded_cache_counts():
...
def test_usage_is_absent_when_codex_reported_no_counts_never_fabricated_zeros():
