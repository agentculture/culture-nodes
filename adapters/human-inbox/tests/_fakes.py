"""Shared test doubles: a tiny stdlib callback receiver, mirroring
`adapters/colleague/tests/_fakes.py` so this bridge's tests speak exactly
the same fake §13.4 receiver shape as the sibling bridges'."""
