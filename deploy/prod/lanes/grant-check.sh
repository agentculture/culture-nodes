...
GRANT_CHECK_DEPLOY_GRANTS='NODES_RUNNER_LISTEN NODES_RUNNER_SECRET_FILE NODES_RUNNER_STATE_DIR NODES_RUNNER_HEADSPACE_PROFILES NODES_RUNNER_HEADSPACE_BIN NODES_API_URL PR_UPKEEP_SWEEP_SOURCE_URL PR_UPKEEP_SWEEP_SOURCE_SHA256 PR_UPKEEP_SWEEP_JIRA_SOURCE_URL PR_UPKEEP_SWEEP_JIRA_SOURCE_SHA256 PR_UPKEEP_SWEEP_EMIT_SOURCE_URL PR_UPKEEP_SWEEP_EMIT_SOURCE_SHA256 PR_UPKEEP_READINESS_SOURCE_URL PR_UPKEEP_READINESS_SOURCE_SHA256 PR_UPKEEP_READINESS_GITHUB_API PR_UPKEEP_READINESS_SONAR_API PR_UPKEEP_READINESS_SONAR_COMPONENT PR_UPKEEP_READINESS_DEVAGUE_ROOT PR_UPKEEP_READINESS_DEVAGUE_SLUG PR_UPKEEP_REPOSITORIES JIRA_TRANSITION_TARGETS JIRA_TRANSITION_PROJECT_PREFIX JIRA_API_BASE'
