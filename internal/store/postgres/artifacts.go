...
// unique (namespace_id, uri) index is migrations/0005_artifact_blobs.sql
...
// (artifacts_namespace_uri_key, migrations/0005_artifact_blobs.sql). Every
...
// statement via ON DELETE CASCADE (migrations/0005_artifact_blobs.sql), and
