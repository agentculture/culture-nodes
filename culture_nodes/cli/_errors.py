...
Every failure inside culture-nodes raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`culture_nodes.cli._output`,
...
# Exit-code policy. Documented in ``culture-nodes learn`` output.
# 0      = success
